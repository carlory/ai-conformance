...
func RunE2ETests(t *testing.T) {
	...
	ginkgo.RunSpecs(t, "Extended Kubernetes e2e suite with AI Conformance", suiteConfig, reporterConfig)
}
...
func setupSuite(ctx context.Context) {
	...
	if framework.TestContext.CleanStart {
		deleted, err := frameworkutil.DeleteNamespaces(ctx, c, nil, /* deleteFilter */
			[]string{"e2e-framework"}, /* deleteLabelFilter */
			[]string{
