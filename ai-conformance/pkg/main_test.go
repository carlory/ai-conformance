...
func TestMain(m *testing.M) {
	...
	if _, ok := os.LookupEnv("KUBERNETES_SERVICE_HOST"); !ok {
		testenv = env.NewWithKubeConfig("/Users/kiki/.kube/config")
	}
...
func deleteNSForTest(ctx context.Context, cfg *envconf.Config, t *testing.T, _ /* runID */ string) (context.Context, error) {
